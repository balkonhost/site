...
@section('main')
    ...
    <div class="container">
        ...
        <p>Стоимость доменного имени может быть изменена в процессе регистрации и не является офертой.
            Так же стоимость PREMIUM доменного имени может отличаться от стандартной стоимости, при попытке заказа
            такого домена, услуга будет отменена, а средства возвращены на баланс лицевого счета.</p>
    </div>
