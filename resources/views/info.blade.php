    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-9">
                ...
                <p>C середины 2020 года успешно не пытаемся привлечь хотя бы одного клиента и у это у нас хорошо получается.
                    За все это время мы так и не разместили ни одного сайта. Возможно и вас не уговорим захостить у нас
                    свой интернет-проект. А все почему? Потому что у нас в коллективе <a href="{{ route('team') }}" title="">собрались
